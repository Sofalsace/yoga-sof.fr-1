...
export const coursesExplicit: Record<CourseType, CourseDataExplicit> = {
  [CourseType.YOGA_ADULT]: {
    ...
    group: `4-6 personnes`,
    duration: `1h15`,
    price: `360 € les 30 séances ou 135 € les 10 séances ou 16 € / séance + cotisation annuelle association 15 € / personne ou 20 € / famille`,
  ...
  [CourseType.YOGA_ADULT_CHILD]: {
    ...
    group: `5 duos`,
    duration: `1h`,
    price: `22 € duos, 30 € trios avec 2 enfants`,
    location: `À définir`,
